expConfig = {
    ...
    "iterationName": "build_components_build_recall_6_towers_3_rep_color_sona_pilot_1",
    ...
    "decodePhaseInstructions":['<p>Great job! Now we want to see how well you remember the towers you have just seen and built.</p><p>On the next screen you\'ll be shown a building window. Your task is to build as many towers as you can remember from the previous part of the study.</p>',
