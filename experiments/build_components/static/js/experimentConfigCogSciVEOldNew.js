expConfig = {
    ...
    "iterationName": "build_components_cogsci_ve_old_new_prolific_pilot_0",
    ...
    '<p>You will be shown 12 towers, one by one, and asked whether they are "<strong>old</strong>" or "<strong>new</strong>".</p><p>If you think you recognize the tower from the first part of the experiment, press "<strong>OLD_KEY</strong>" to respond "<strong>old</strong>".</br>If you think you have not seen the tower before, press "<strong>NEW_KEY</strong>" to respond "<strong>new</strong>".</p><p>This part of the experiment is designed to be difficult! The towers you see will be <em>very similar</em> to each other. If you are unsure whether you saw the tower in the previous part of the experiment, please give your best guess.</p><p>Press Next to start.</p>'],
